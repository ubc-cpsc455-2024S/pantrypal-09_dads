...
const RecipeGeneration = ({ dispatch }) => {
  ...
  const suggestedRecipes = useSelector(
    (state) => state.recipe.suggestedRecipes,
  );
  ...
  useEffect(() => {}, [dispatch, suggestedRecipes]);
          ...
          <ModalBody>
            ...
            >
              ...
              <VStack alignItems="flex-start">
                <Heading as="h3" fontSize="1rem" fontWeight="500" color="#333">
                  {
                ...
                <form onSubmit={handleSubmit}>
                  <Textarea
                    ...
                    id="preferences"
                    value={generator}
                    minW={{ base: "none", md: "500px" }}
                    onChange={(e) => setGenerator(e.target.value)}
                  />
                  <HStack alignItems={"flex-center"} mt={5}>
                    <Button mr={5} type="submit" disabled={loading}>
                      Generate
                    </Button>
