...
const PreferencePage = () => {
  ...
  return (
    ...
    >
      <Heading as="h1" color="#333" marginBottom="1rem">
        Preferences
      </Heading>
      <VStack alignItems="flex-start" maxW={"80%"} mx="auto">
        <Heading as="h2" color="#333">
          Preferred Name
        </Heading>
        <Card padding={"2em"}>
        ...
        <Divider />
        <Heading as="h2" color="#333" marginBottom="1rem">
        ...
        <Card padding={"2em"}>
          <Heading
            ...
            mb="10px"
          >
            Please add any Restrictions that you would like for us to take into
            account!
          </Heading>
          <form onSubmit={handleSubmit}>
            <Text mb="10px">
              Here are your current preferences: <br />
              <b>{preference}</b>
            </Text>
            <Textarea
              type="preferences"
